...
class ExpensesCategorySumary(APIView):
    ...
    def get(self, request):
        ...
        return response.Response({'category_data_total_amount_year_ago': result}, status=status.HTTP_200_OK)
...
class IncomeSourceSumary(APIView):
    ...
    def get(self, request):
        ...
        return response.Response({'income_data_total_amount_year_ago': result}, status=status.HTTP_200_OK)
